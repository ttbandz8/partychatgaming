...
class CrownUnlimited(commands.Cog):
    ...
    async def ctales(self, ctx, user: User):
        ...
        while continued == True:
            ...
            c_moveset = c['MOVESET']
            c_attack = c['ATK'] + ((2 * currentopponent) + player_scaling)
            c_defense = c['DEF'] + ((2 * currentopponent) + player_scaling)
            c_type = c['TYPE']
            c_accuracy = c['ACC']
            c_passive = c['PASS'][0]
            c_speed = c['SPD']
            ...
            t_defense = t['DEF'] + ((18 * currentopponent) + opponent_scaling + 50)
            t_type = t['TYPE']
            t_accuracy = t['ACC']
            t_passive = t['PASS'][0]
            t_speed = t['SPD']
    ...
    async def cdungeon(self, ctx, user: User):
        ...
        while continued == True:
            ...
            t_card_path=t['PATH']
            t_rcard_path=t['RPATH']
            t_max_health = t['HLT'] + ((80 * currentopponent) + opponent_scaling + 1800) 
            t_health = t['HLT'] + ((80 * currentopponent) + opponent_scaling + 1800)
            t_stamina = t['STAM']
            t_max_stamina= t['STAM']
            t_moveset = t['MOVESET']
            t_attack = t['ATK'] + ((20 * currentopponent) + opponent_scaling + 45)
            t_defense = t['DEF'] + ((30 * currentopponent) + opponent_scaling + 80)
            t_type = t['TYPE']
            t_accuracy = t['ACC']
            t_passive = t['PASS'][0]
            t_speed = t['SPD']
    ...
    async def dungeon(self, ctx):
        ...
        while continued == True:
            ...
            o_card_path=o['PATH']
            o_rcard_path=o['RPATH']
            o_max_health = o['HLT'] - ((10 * currentopponent) + player_scaling)
            o_health = o['HLT'] - ((10 * currentopponent) + player_scaling)
            o_stamina = o['STAM']
            o_max_stamina = o['STAM']
            o_moveset = o['MOVESET']
            o_attack = o['ATK']
            ...
            t_max_stamina= t['STAM']
            t_moveset = t['MOVESET']
            t_attack = t['ATK'] + ((20 * currentopponent) + opponent_scaling + 25)
            t_defense = t['DEF'] + ((20 * currentopponent + opponent_scaling) + 45)
            t_type = t['TYPE']
            t_accuracy = t['ACC']
            t_passive = t['PASS'][0]
            t_speed = t['SPD']
