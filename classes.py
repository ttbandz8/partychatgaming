...
class VAULT():
    ...
    CARD_LEVELS: list[str] = field(default_factory=lambda: [{'CARD': 'Eevee', 'LVL': 0, 'EXP': 0, 'HLT': 0, 'ATK': 0, 'DEF': 0}, {'CARD': 'Ochaco Uraraka', 'LVL': 0, 'EXP': 0, 'HLT': 0, 'ATK': 0, 'DEF': 0}, {'CARD': 'Garen', 'LVL': 0, 'EXP': 0, 'HLT': 0, 'ATK': 0, 'DEF': 0}])
