...
class BOSS():
    ...
    AVAILABLE: bool = field(default_factory=lambda: True)
    PET: list[str] = field(default_factory=lambda: [{'NAME': 'Chick', 'LVL': 1, 'EXP': 0, 'Glare': 1, 'TYPE': 'FEAR', 'BOND': 0, 'PATH': "https://res.cloudinary.com/dkcmq8o15/image/upload/v1622307902/Pets/chick.jpg"}])
